...
Refer to this [sample-catalog.yml](./sample-catalog-viewer.md) to see how various data sources and file types are documented. Each dataset is given a human-readable name, with optional metadata associated.
