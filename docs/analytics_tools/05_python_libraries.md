...
## shared utils
A set of shared utility functions can also be installed, similarly to any Python library. The [shared_utils](https://github.com/cal-itp/data-analyses/shared_utils) are stored here; functions are added as collaborative work evolves so we aren't constantly reinventing the wheel.
