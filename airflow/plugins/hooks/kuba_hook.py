...
class KubaHook(BaseHook):
    ...
    def _get_connection(self):
        ...
        kuba_api = HttpHook(method='POST', http_conn_id=self.http_conn_id)
    ...
    def get_headers(self):
        return {
            ...
            'Cookie': f'session-id={self.session_id}'
        }
    ...
    def run(self, endpoint, data=None, headers=None):
        ...
        kuba_api = HttpHook(method=self.method, http_conn_id=self.http_conn_id)
