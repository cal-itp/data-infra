...
def model_vp_trajectory():
    ...
    model_trajectory = BigQueryVehicleLocationsToTrajectory(
        task_id="bigquery_vehicle_locations_to_trajectory",
        retries=1,
        ...
        destination_path="vehicle_locations_trajectory/service_date={{ data_interval_end | ds }}.jsonl.gz",
    )

    model_trajectory >> create_external_table 
    #TODO how to add the task to create the external table from the hive-partitioned bucket?
