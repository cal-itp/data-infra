...
from operators.mobility_database_to_gcs_operator import AggregatorObjectPath, MobilityDatabaseToGCSOperator
...
class TestMobilityDatabaseToGCSOperator:
    ...
    def test_execute(
        ...
        compressed_result = gcs_hook.download(
            bucket_name=os.environ.get("CALITP_BUCKET__AGGREGATOR_SCRAPER").replace("gs://", ""),
