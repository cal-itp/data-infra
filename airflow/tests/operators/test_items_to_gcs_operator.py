...
class TestItemsToGCSOperator:
    ...
    @pytest.fixture
    def operator(self, test_dag: DAG) -> ItemsToGCSOperator:
        return ItemsToGCSOperator(
            task_id="items_to_gcs",
    ...
    def test_execute(
        ...
        task = test_dag.get_task("items_to_gcs")
        ...
        assert list(reader) == [{"testing_date": "2025-06-01"}]
