...
class TestValidateGTFSToGCSOperator:
    ...
    def execution_date(self) -> datetime:
        return datetime.fromisoformat("2025-06-03T03:05:52.760554+00:00")
    ...
    def source_path(self) -> str:
        return "schedule/dt=2025-06-03/ts=2025-06-03T03:05:52.760554+00:00/base64_url=aHR0cDovL2FwcC5tZWNhdHJhbi5jb20vdXJiL3dzL2ZlZWQvYzJsMFpUMXplWFowTzJOc2FXVnVkRDF6Wld4bU8yVjRjR2x5WlQwN2RIbHdaVDFuZEdaek8ydGxlVDAwTWpjd056UTBaVFk0TlRBek9UTXlNREl4TURkak56STBNRFJrTXpZeU5UTTRNekkwWXpJMA==/gtfs.zip"

    @pytest.fixture
    def destination_path(self) -> str:
        return "validation_notices/dt=2025-06-03/ts=2025-06-03T03:05:52.760554+00:00/base64_url=aHR0cDovL2FwcC5tZWNhdHJhbi5jb20vdXJiL3dzL2ZlZWQvYzJsMFpUMXplWFowTzJOc2FXVnVkRDF6Wld4bU8yVjRjR2x5WlQwN2RIbHdaVDFuZEdaek8ydGxlVDAwTWpjd056UTBaVFk0TlRBek9UTXlNREl4TURkak56STBNRFJrTXpZeU5UTTRNekkwWXpJMA=="

    @pytest.fixture
    def results_path(self) -> str:
        return "validation_job_results/dt=2025-06-03/ts=2025-06-03T03:05:52.760554+00:00/aHR0cDovL2FwcC5tZWNhdHJhbi5jb20vdXJiL3dzL2ZlZWQvYzJsMFpUMXplWFowTzJOc2FXVnVkRDF6Wld4bU8yVjRjR2x5WlQwN2RIbHdaVDFuZEdaek8ydGxlVDAwTWpjd056UTBaVFk0TlRBek9UTXlNREl4TURkak56STBNRFJrTXpZeU5UTTRNekkwWXpJMA==.jsonl"
    ...
    def download_schedule_feed_results(self) -> dict:
        return {
            ...
            "extract": {
                "filename": "gtfs.zip",
                "ts": "2025-06-03T03:05:52.760554+00:00",
                "config": {
                    "auth_headers": {},
                    "auth_query_params": {},
                    "computed": False,
    ...
    def test_execute(
        ...
        compressed_notices = gcs_hook.download(
            ...
            object_name="validation_notices/dt=2025-06-03/ts=2025-06-03T03:05:52.760554+00:00/base64_url=aHR0cDovL2FwcC5tZWNhdHJhbi5jb20vdXJiL3dzL2ZlZWQvYzJsMFpUMXplWFowTzJOc2FXVnVkRDF6Wld4bU8yVjRjR2x5WlQwN2RIbHdaVDFuZEdaek8ydGxlVDAwTWpjd056UTBaVFk0TlRBek9UTXlNREl4TURkak56STBNRFJrTXpZeU5UTTRNekkwWXpJMA==/validation_notices_v5-0-0.jsonl.gz",
        )
        ...
        unparsed_results = gcs_hook.download(
            ...
            object_name="validation_job_results/dt=2025-06-03/ts=2025-06-03T03:05:52.760554+00:00/aHR0cDovL2FwcC5tZWNhdHJhbi5jb20vdXJiL3dzL2ZlZWQvYzJsMFpUMXplWFowTzJOc2FXVnVkRDF6Wld4bU8yVjRjR2x5WlQwN2RIbHdaVDFuZEdaek8ydGxlVDAwTWpjd056UTBaVFk0TlRBek9UTXlNREl4TURkak56STBNRFJrTXpZeU5UTTRNekkwWXpJMA==.jsonl",
        )
