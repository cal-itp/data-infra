...
Entity mapping links payments data from vendors (Littlepay, Enghouse) to Cal-ITP's transit database entities (GTFS datasets and Organizations). This guide shows you how to add or update entity mappings.
...
- Agency changes organization affiliation
- Elavon customer name changes
