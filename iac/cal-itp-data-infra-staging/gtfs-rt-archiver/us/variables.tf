...
# selects apply targets with files: 'iac/cal-itp-data-infra-staging/**/*.tf'
...
variable "high_frequency_cohort" {
  description = "Download config names to archive on the high-frequency clock. Empty list disables the lane entirely."
  type        = list(string)
  default     = []
