resource "google_storage_bucket_object" "calitp-staging-composer3" {
  ...
  bucket   = data.terraform_remote_state.gcs.outputs.google_storage_bucket_calitp-staging-composer3_id
}

resource "google_storage_bucket_object" "calitp-staging-composer3-dags" {
...
resource "google_storage_bucket_object" "calitp-staging-composer3-manifest" {
...
resource "google_storage_bucket_object" "calitp-staging-composer3-catalog" {
...
resource "google_storage_bucket_object" "calitp-staging-composer3-index" {
