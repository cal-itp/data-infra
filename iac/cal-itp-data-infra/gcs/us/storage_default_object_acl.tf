resource "google_storage_default_object_acl" "tfer--analysis-output-models" {
  bucket = "analysis-output-models"
}

resource "google_storage_default_object_acl" "tfer--artifacts-002E-cal-itp-data-infra-002E-appspot-002E-com" {
  bucket      = "artifacts.cal-itp-data-infra.appspot.com"
  role_entity = ["OWNER:project-editors-1005246706141", "OWNER:project-owners-1005246706141", "READER:project-viewers-1005246706141"]
}

resource "google_storage_default_object_acl" "tfer--cal-itp-data-infra-002E-appspot-002E-com" {
  bucket      = "cal-itp-data-infra.appspot.com"
  role_entity = ["OWNER:project-editors-1005246706141", "OWNER:project-owners-1005246706141", "READER:project-viewers-1005246706141"]
}

resource "google_storage_default_object_acl" "tfer--calitp-aggregator-scraper" {
  bucket = "calitp-aggregator-scraper"
}

resource "google_storage_default_object_acl" "tfer--calitp-airtable" {
  bucket = "calitp-airtable"
}

resource "google_storage_default_object_acl" "tfer--calitp-amplitude-benefits-events" {
  bucket = "calitp-amplitude-benefits-events"
}

resource "google_storage_default_object_acl" "tfer--calitp-analytics-data" {
  bucket = "calitp-analytics-data"
}

resource "google_storage_default_object_acl" "tfer--calitp-backups-grafana" {
  bucket = "calitp-backups-grafana"
}

resource "google_storage_default_object_acl" "tfer--calitp-backups-metabase" {
  bucket = "calitp-backups-metabase"
}

resource "google_storage_default_object_acl" "tfer--calitp-backups-sentry" {
  bucket = "calitp-backups-sentry"
}

resource "google_storage_default_object_acl" "tfer--calitp-backups-test" {
  bucket = "calitp-backups-test"
}

resource "google_storage_default_object_acl" "tfer--calitp-ci-artifacts" {
  bucket = "calitp-ci-artifacts"
}

resource "google_storage_default_object_acl" "tfer--calitp-dbt-artifacts" {
  bucket = "calitp-dbt-artifacts"
}

resource "google_storage_default_object_acl" "tfer--calitp-dbt-python-models" {
...
resource "google_storage_default_object_acl" "tfer--calitp-gtfs-rt-parsed" {
...
resource "google_storage_default_object_acl" "tfer--calitp-gtfs-rt-validation" {
  bucket = "calitp-gtfs-rt-validation"
}

resource "google_storage_default_object_acl" "tfer--calitp-gtfs-schedule-parsed" {
  bucket = "calitp-gtfs-schedule-parsed"
}

resource "google_storage_default_object_acl" "tfer--calitp-gtfs-schedule-parsed-hourly" {
  bucket = "calitp-gtfs-schedule-parsed-hourly"
}

resource "google_storage_default_object_acl" "tfer--calitp-gtfs-schedule-raw-v2" {
  bucket = "calitp-gtfs-schedule-raw-v2"
}

resource "google_storage_default_object_acl" "tfer--calitp-gtfs-schedule-unzipped" {
  bucket = "calitp-gtfs-schedule-unzipped"
}

resource "google_storage_default_object_acl" "tfer--calitp-gtfs-schedule-unzipped-hourly" {
  bucket = "calitp-gtfs-schedule-unzipped-hourly"
}

resource "google_storage_default_object_acl" "tfer--calitp-gtfs-schedule-validation" {
  bucket = "calitp-gtfs-schedule-validation"
}

resource "google_storage_default_object_acl" "tfer--calitp-gtfs-schedule-validation-hourly" {
...
resource "google_storage_default_object_acl" "tfer--calitp-metabase-data-public" {
  bucket = "calitp-metabase-data-public"
}

resource "google_storage_default_object_acl" "tfer--calitp-ntd-api-products" {
  bucket = "calitp-ntd-api-products"
}

resource "google_storage_default_object_acl" "tfer--calitp-ntd-data-products" {
  bucket = "calitp-ntd-data-products"
}

resource "google_storage_default_object_acl" "tfer--calitp-ntd-report-validation" {
  bucket = "calitp-ntd-report-validation"
}

resource "google_storage_default_object_acl" "tfer--calitp-ntd-xlsx-products-clean" {
  bucket = "calitp-ntd-xlsx-products-clean"
}

resource "google_storage_default_object_acl" "tfer--calitp-ntd-xlsx-products-raw" {
  bucket = "calitp-ntd-xlsx-products-raw"
}

resource "google_storage_default_object_acl" "tfer--calitp-payments-littlepay-parsed" {
...
resource "google_storage_default_object_acl" "tfer--calitp-publish" {
  bucket = "calitp-publish"
}

resource "google_storage_default_object_acl" "tfer--calitp-publish-data-analysis" {
  bucket = "calitp-publish-data-analysis"
}

resource "google_storage_default_object_acl" "tfer--calitp-reports-data" {
  bucket = "calitp-reports-data"
}

resource "google_storage_default_object_acl" "tfer--calitp-state-geoportal-scrape" {
  bucket = "calitp-state-geoportal-scrape"
}
...
resource "google_storage_default_object_acl" "tfer--dataproc-staging-us-west2-1005246706141-sfgmtgyp" {
  bucket      = "dataproc-staging-us-west2-1005246706141-sfgmtgyp"
  role_entity = ["OWNER:project-editors-1005246706141", "OWNER:project-owners-1005246706141", "READER:project-viewers-1005246706141"]
}

resource "google_storage_default_object_acl" "tfer--dataproc-temp-us-west2-1005246706141-x9mtxbwg" {
...
resource "google_storage_default_object_acl" "tfer--dev-calitp-gtfs-rt-raw" {
  bucket = "dev-calitp-gtfs-rt-raw"
}

resource "google_storage_default_object_acl" "tfer--dev-calitp-test-sandbox" {
...
resource "google_storage_default_object_acl" "tfer--gtfs-data-reports" {
  bucket = "gtfs-data-reports"
}

resource "google_storage_default_object_acl" "tfer--gtfs-data-test" {
  bucket = "gtfs-data-test"
}

resource "google_storage_default_object_acl" "tfer--gtfs-data-test-reports" {
...
resource "google_storage_default_object_acl" "tfer--test-calitp-airtable" {
  bucket = "test-calitp-airtable"
}

resource "google_storage_default_object_acl" "tfer--test-calitp-dbt-artifacts" {
  bucket = "test-calitp-dbt-artifacts"
}

resource "google_storage_default_object_acl" "tfer--test-calitp-dbt-python-models" {
...
resource "google_storage_default_object_acl" "tfer--test-calitp-gtfs-download-config" {
...
resource "google_storage_default_object_acl" "tfer--test-calitp-gtfs-rt-raw" {
  bucket = "test-calitp-gtfs-rt-raw"
}

resource "google_storage_default_object_acl" "tfer--test-calitp-gtfs-rt-raw-v2" {
  bucket = "test-calitp-gtfs-rt-raw-v2"
}

resource "google_storage_default_object_acl" "tfer--test-calitp-gtfs-rt-validation" {
  bucket = "test-calitp-gtfs-rt-validation"
}

resource "google_storage_default_object_acl" "tfer--test-calitp-gtfs-schedule-parsed" {
...
resource "google_storage_default_object_acl" "tfer--test-calitp-gtfs-schedule-raw" {
  bucket = "test-calitp-gtfs-schedule-raw"
}

resource "google_storage_default_object_acl" "tfer--test-calitp-gtfs-schedule-raw-v2" {
  bucket = "test-calitp-gtfs-schedule-raw-v2"
}

resource "google_storage_default_object_acl" "tfer--test-calitp-gtfs-schedule-raw-v2-backfill-test" {
  bucket = "test-calitp-gtfs-schedule-raw-v2-backfill-test"
}

resource "google_storage_default_object_acl" "tfer--test-calitp-gtfs-schedule-unzipped" {
  bucket = "test-calitp-gtfs-schedule-unzipped"
}

resource "google_storage_default_object_acl" "tfer--test-calitp-gtfs-schedule-unzipped-hourly" {
...
resource "google_storage_default_object_acl" "tfer--test-calitp-ntd-data-products" {
...
resource "google_storage_default_object_acl" "tfer--test-calitp-state-geoportal-scrape" {
  bucket = "test-calitp-state-geoportal-scrape"
}

resource "google_storage_default_object_acl" "tfer--test-rt-parsed" {
  bucket = "test-rt-parsed"
}

resource "google_storage_default_object_acl" "tfer--test-rt-validations" {
  bucket = "test-rt-validations"
}

resource "google_storage_default_object_acl" "tfer--us-002E-artifacts-002E-cal-itp-data-infra-002E-appspot-002E-com" {
  bucket      = "us.artifacts.cal-itp-data-infra.appspot.com"
  role_entity = ["OWNER:project-editors-1005246706141", "OWNER:project-owners-1005246706141", "READER:project-viewers-1005246706141"]
}

resource "google_storage_default_object_acl" "tfer--us-west2-calitp-airflow2-pr-171e4e47-bucket" {
  bucket      = "us-west2-calitp-airflow2-pr-171e4e47-bucket"
  role_entity = ["OWNER:project-editors-1005246706141", "OWNER:project-owners-1005246706141", "READER:project-viewers-1005246706141"]
}

resource "google_storage_default_object_acl" "tfer--us-west2-calitp-airflow2-pr-31e41084-bucket" {
  bucket      = "us-west2-calitp-airflow2-pr-31e41084-bucket"
  role_entity = ["OWNER:project-editors-1005246706141", "OWNER:project-owners-1005246706141", "READER:project-viewers-1005246706141"]
}

resource "google_storage_default_object_acl" "tfer--us-west2-calitp-airflow2-pr-88ca8ec6-bucket" {
