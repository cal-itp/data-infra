...
resource "google_compute_firewall" "tfer--gke-us-west2-calitp-airflow2-pr-88ca8ec6-gke-98ed8a64-all" {
  allow {
    protocol = "ah"
  }
  ...
  target_tags   = ["gke-us-west2-calitp-airflow2-pr-88ca8ec6-gke-98ed8a64-node"]
}

resource "google_compute_firewall" "tfer--gke-us-west2-calitp-airflow2-pr-88ca8ec6-gke-98ed8a64-exkubelet" {
  deny {
    ports    = ["10255"]
    protocol = "tcp"
  }
...
resource "google_compute_firewall" "tfer--gke-us-west2-calitp-airflow2-pr-88ca8ec6-gke-98ed8a64-inkubelet" {
  allow {
    ports    = ["10255"]
    protocol = "tcp"
  }
  ...
  project       = "cal-itp-data-infra"
  source_ranges = ["10.15.0.0/17"]
  source_tags   = ["gke-us-west2-calitp-airflow2-pr-88ca8ec6-gke-98ed8a64-node"]
  target_tags   = ["gke-us-west2-calitp-airflow2-pr-88ca8ec6-gke-98ed8a64-node"]
}

resource "google_compute_firewall" "tfer--gke-us-west2-calitp-airflow2-pr-88ca8ec6-gke-98ed8a64-vms" {
  allow {
    ports    = ["1-65535"]
    protocol = "tcp"
  }
