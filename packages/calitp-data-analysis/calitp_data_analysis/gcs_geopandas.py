...
class GCSGeoPandas:
    ...
    def read_parquet(self, path, *args, **kwargs):
        ...
        return geopandas.read_parquet(path, storage_options=storage_options, *args, **kwargs)
    ...
    def geo_data_frame_to_parquet(self, geo_data_frame, path, *args, **kwargs):
        ...
        return geo_data_frame.to_parquet(path, filesystem=gcs_filesystem, *args, **kwargs)