...
daily_feeds AS (
    ...
    FROM gtfs_schedule_dim_feeds Feeds
    JOIN dim_date AS D
        ON
...
feed_status AS (
    ...
    FROM daily_feeds
    LEFT JOIN calitp_status download_status
        ON
    ...
    LEFT JOIN calitp_feed_parse_result parse_result
        ON
...
feed_updated AS (
    ...
    FROM feed_status T1
    LEFT JOIN calitp_feed_updates T2
        ON
