...
WITH int_gtfs_quality__guideline_checks_long AS (
    ...
    WHERE organization_key IS NOT NULL
        AND public_customer_facing_fixed_route OR public_customer_facing_or_regional_subfeed_fixed_route
),
...
fct_daily_organization_combined_guideline_checks AS (
    ...
    GROUP BY date, organization_key, organization_source_record_id, organization_name, feature, check,
     is_manual, reports_order, public_customer_facing_fixed_route, public_customer_facing_or_regional_subfeed_fixed_route
)
