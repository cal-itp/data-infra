...
month_comparison AS (
    SELECT
        ...
        month_start.stop_id AS start_table_source_id,
        month_end.stop_id AS stop_table_source_id,

        CASE
            WHEN month_end.stop_id IS NULL THEN 'Removed'
            WHEN month_start.stop_id IS NULL THEN 'Added'
            ELSE 'Unchanged'
