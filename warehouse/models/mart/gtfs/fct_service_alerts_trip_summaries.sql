...
fct_service_alerts_trip_summaries AS (
    SELECT
        ...
        COALESCE(min_header_timestamp, min_extract_ts) AS min_ts,
        COALESCE(min_header_datetime_pacific, min_extract_datetime_pacific) AS min_datetime_pacific,
        COALESCE(max_header_timestamp, max_extract_ts) AS max_ts,
        COALESCE(max_header_datetime_pacific, max_extract_datetime_pacific) AS max_datetime_pacific,
        min_extract_ts,
        max_extract_ts,
