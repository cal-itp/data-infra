...
fct_vehicle_positions_trip_summaries AS (
    SELECT
        ...
        COALESCE(min_vehicle_timestamp, min_header_timestamp, min_extract_ts) AS min_vp_ts,
        COALESCE(min_vehicle_datetime_pacific, min_header_datetime_pacific, min_extract_datetime_pacific) AS min_vp_datetime_pacific,
        COALESCE(max_vehicle_timestamp, max_header_timestamp, max_extract_ts) AS max_vp_ts,
        COALESCE(max_vehicle_datetime_pacific, max_header_datetime_pacific, max_extract_datetime_pacific) AS max_vp_datetime_pacific,
        min_extract_ts,
        max_extract_ts,
