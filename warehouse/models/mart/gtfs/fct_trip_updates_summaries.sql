...
fct_trip_updates_summaries AS (
    SELECT
        ...
        COALESCE(min_trip_update_timestamp, min_header_timestamp, min_extract_ts) AS min_tu_ts,
        COALESCE(min_trip_update_datetime_pacific, min_header_datetime_pacific, min_extract_datetime_pacific) AS min_tu_datetime_pacific,
        COALESCE(max_trip_update_timestamp, max_header_timestamp, max_extract_ts) AS max_tu_ts,
        COALESCE(max_trip_update_datetime_pacific, max_header_datetime_pacific, max_extract_datetime_pacific) AS max_tu_datetime_pacific,
        min_extract_ts,
        max_extract_ts,
