...
gtfs_joins AS (
    SELECT
        ...
        stop_times_grouped.flexible_trip,
        stop_times_grouped.fully_flexible_trip,
        stop_times_grouped.num_flexible_stop_times,
        stop_times_grouped.first_start_pickup_drop_off_window_sec,
        stop_times_grouped.last_end_pickup_drop_off_window_sec,
        stop_times_grouped.num_regularly_scheduled_pickup_stop_times,
        stop_times_grouped.num_no_pickup_stop_times,
        stop_times_grouped.num_phone_call_required_for_pickup_stop_times,
        stop_times_grouped.num_coordinate_pickup_with_driver_stop_times,
        stop_times_grouped.num_regularly_scheduled_drop_off_stop_times,
        stop_times_grouped.num_no_drop_off_stop_times,
        stop_times_grouped.num_phone_call_required_for_drop_off_stop_times,
        stop_times_grouped.num_coordinate_drop_off_with_driver_stop_times,
        stop_times_grouped.num_continuous_pickup_stop_times,
        stop_times_grouped.num_no_continuous_pickup_stop_times,
        stop_times_grouped.num_phone_call_required_for_continuous_pickup_stop_times,
        stop_times_grouped.num_coordinate_continuous_pickup_with_driver_stop_times,
        stop_times_grouped.num_continuous_drop_off_stop_times,
        stop_times_grouped.num_no_continuous_drop_off_stop_times,
        stop_times_grouped.num_phone_call_required_for_continuous_drop_off_stop_times,
        stop_times_grouped.num_coordinate_continuous_drop_off_with_driver_stop_times,
...
fct_daily_scheduled_trips AS (
    SELECT
        ...
        gtfs_joins.flexible_trip,
        gtfs_joins.fully_flexible_trip,
        gtfs_joins.num_flexible_stop_times,
        gtfs_joins.num_regularly_scheduled_pickup_stop_times,
        gtfs_joins.num_no_pickup_stop_times,
        gtfs_joins.num_phone_call_required_for_pickup_stop_times,
        gtfs_joins.num_coordinate_pickup_with_driver_stop_times,
        gtfs_joins.num_regularly_scheduled_drop_off_stop_times,
        gtfs_joins.num_no_drop_off_stop_times,
        gtfs_joins.num_phone_call_required_for_drop_off_stop_times,
        gtfs_joins.num_coordinate_drop_off_with_driver_stop_times,
        gtfs_joins.num_continuous_pickup_stop_times,
        gtfs_joins.num_no_continuous_pickup_stop_times,
        gtfs_joins.num_phone_call_required_for_continuous_pickup_stop_times,
        gtfs_joins.num_coordinate_continuous_pickup_with_driver_stop_times,
        gtfs_joins.num_continuous_drop_off_stop_times,
        gtfs_joins.num_no_continuous_drop_off_stop_times,
        gtfs_joins.num_phone_call_required_for_continuous_drop_off_stop_times,
        gtfs_joins.num_coordinate_continuous_drop_off_with_driver_stop_times,
