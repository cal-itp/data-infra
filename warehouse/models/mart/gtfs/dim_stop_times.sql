...
dim_stop_times AS (
    SELECT
        ...
        _valid_from,
        _valid_to,
        part_arr[OFFSET(0)] * 3600 + part_arr[OFFSET(1)] * 60 + part_arr[OFFSET(2)] AS arrival_sec,
        part_dep[OFFSET(0)] * 3600 + part_dep[OFFSET(1)] * 60 + part_dep[OFFSET(2)] AS departure_sec
    FROM array_len_fix
)
