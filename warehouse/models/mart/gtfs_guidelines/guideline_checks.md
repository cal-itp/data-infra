...
|No shapes-related notices appear in the MobilityData GTFS Validator | Accurate Service Data | None of the following shapes-related notices appear in the GTFS Schedule Validator: Decreasing_shape_distanc,Equal_shape_distance_diff_coordinate,decreasing_or_equal_shape_distanc,Equal_shape_distance_same_coordinate,Stops_match_shape_out_of_orde,Stop_too_far_from_shap,Stop_too_far_from_shape_using_user_distanc,Stop_too_far_from_trip_shap,decreasing_or_equal_shape_distance |
