...
dim_agency_service__2022__average_weekday_pm_peak as (
    SELECT
    ...
    WHERE time_period = 'Average Weekday - PM Peak'

)
SELECT * FROM dim_agency_service__2022__average_weekday_pm_peak
