WITH int_ntd__operating_and_capital_funding_time_series_capital_total AS (
    SELECT *
...
fct_operating_and_capital_funding_time_series_capital_total AS (
    ...
    WHERE int.key NOT IN ('21f4adad5adcd91c37292b036d47370d','7417b3a1931fc284be99824925f55d55','4c39c378621ca926c1e98efc929a64f9',
        'ceee48d5b549eacd30c16bc7af1ec79d')
)
