...
enrich_with_caltrans_district AS (
    SELECT
        int_ntd__service_data_and_operating_expenses_time_series_by_mode_opexp_total.*,
        current_dim_organizations.caltrans_district
    FROM int_ntd__service_data_and_operating_expenses_time_series_by_mode_opexp_total
...
SELECT
    ...
    dt,
    execution_ts
FROM fct_service_data_and_operating_expenses_time_series_by_mode_opexp_total
