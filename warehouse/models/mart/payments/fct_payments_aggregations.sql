...
join_orgs AS (
    ...
    LEFT JOIN payments_entity_mapping
        ...
        AND CAST(join_payments.aggregation_datetime AS TIMESTAMP) BETWEEN CAST(payments_entity_mapping._in_use_from AS TIMESTAMP) AND CAST(payments_entity_mapping._in_use_until AS TIMESTAMP)
    LEFT JOIN orgs
