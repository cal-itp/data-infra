...
fct_payments_aggregations AS (
    SELECT
        ...
        DATETIME(latest_transaction_time, "UTC") AS latest_micropayment_transaction_datetime,
        DATETIME(latest_transaction_time, "America/Los_Angeles") AS latest_micropayment_transaction_datetime_pacific,
        num_micropayments,
        ...
        DATETIME(authorisation_date_time_utc, "UTC") AS latest_authorisation_update_datetime,
        contains_imputed_type AS settlement_contains_imputed_type,
        DATETIME(latest_update_timestamp, "UTC") AS latest_settlement_update_datetime,
        DATETIME(latest_update_timestamp, "America/Los_Angeles") AS latest_settlement_update_datetime_pacific,
