...
{% docs column_avg_daily_stop_arrivals %}

Scheduled stop arrivals are scheduled stop times.
The total stop arrivals / n_service_dates for the period.

{% enddocs %}


{% docs column_monthly_stop_arrivals %}

Scheduled stop arrivals are scheduled stop times.
The count of stop arrivals, the count of scheduled stop arrivals, per month.

{% enddocs %}


{% docs column_hours_in_service %}

Number of hours in service per day.
It is the distinct number of arrival hours based on a scheduled stop_time's arrival_time column.

{% enddocs %}


{% docs column_monthly_hours_in_service %}

Number of hours in service per month.
It is the total number of arrival hours based on a scheduled stop_time's arrival_time column.
...
{% docs column_monthly_stop_arrivals_by_time_of_day %}

Total of arrivals during the time-of-day per month.
