...
WITH stop_time_updates AS (
    ...
    WHERE dt >= "2025-06-01" AND base64_url = "aHR0cHM6Ly9zMy5hbWF6b25hd3MuY29tL2V0YXRyYW5zaXQuZ3Rmcy90cmFjZXIuZXRhc3BvdC5uZXQvdHJpcF91cGRhdGVzLnBi" AND schedule_base64_url = "aHR0cDovL3MzLmFtYXpvbmF3cy5jb20vZXRhdHJhbnNpdC5ndGZzL3RyYWNlci5ldGFzcG90Lm5ldC9ndGZzLnppcA=="
),
