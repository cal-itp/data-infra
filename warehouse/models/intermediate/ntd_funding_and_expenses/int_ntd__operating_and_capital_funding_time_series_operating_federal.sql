...
WITH
    source_pivoted AS (
        {{
            dbt_utils.unpivot(
                cast_to="int",
                relation=ref("stg_ntd__operating_and_capital_funding_time_series__operating_federal"),
                exclude=[
                    "_2023_status",
                    "agency_name",
                    "agency_status",
...
SELECT * FROM int_ntd__operating_and_capital_funding_time_series_operating_federal
