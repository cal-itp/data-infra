...
remove_special_characters AS (
    ...
    FROM src_elavon__billing
),

clean_and_parse_date AS (
    SELECT
...
stg_elavon__billing AS (
    ...
    FROM clean_and_parse_date
)

SELECT * FROM stg_elavon__billing
