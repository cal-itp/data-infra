...
clean_columns AS (
    SELECT
        ...
        {{ trim_make_empty_string_null('zoned_capping_price_type') }} AS zoned_capping_price_type,
        ...
        {{ dbt_utils.generate_surrogate_key(['participant_id', 'product_id', 'previous_version_id', 'original_version_id', 'product_code',
            ...
            'zoned_capping_price_type', 'on_peak_zones', 'off_peak_zones', 'incentive_enabled', 'incentive_type',
