...
clean_columns AS (
    SELECT
        ...
        -- this field is deprecated in v3, but keeping it here for the union with v1, so as to not risk breaking dashboards
        ...
        -- removing 'issuer' from hash because it is not included in feed v3
