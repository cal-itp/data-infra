WITH source AS (
    SELECT * FROM {{ source('external_littlepay_v3', 'products') }}
),
...
clean_columns AS (
    SELECT
        ...
        -- renamed product_created_timestamp_utc in v3, this was created_date in v1
        {{ trim_make_empty_string_null('product_created_timestamp_utc') }} AS created_date,
        ...
        -- renamed scheduled_start_timestamp_utc in v3, this was scheduled_start_date_time in v1
        {{ safe_cast('scheduled_start_timestamp_utc', 'DATE') }} AS scheduled_start_date_time,

        -- renamed scheduled_end_timestamp_utc in v3, this was scheduled_end_date_time in v1
        {{ safe_cast('scheduled_end_timestamp_utc', 'DATE') }} AS scheduled_end_date_time,
        ...
        {{ dbt_utils.generate_surrogate_key(['participant_id', 'product_id', 'previous_version_id', 'original_version_id', 'product_code',
            ...
            'product_created_timestamp_utc', 'capping_type', 'multi_operator', 'capping_start_time',
            'capping_end_time', 'rules_transaction_types', 'rules_default_limit',
            'rules_max_fare_value', 'scheduled_start_timestamp_utc', 'scheduled_end_timestamp_utc',
