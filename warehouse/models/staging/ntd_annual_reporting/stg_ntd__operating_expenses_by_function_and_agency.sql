...
SELECT
    ...
    SAFE_CAST({{ trim_make_empty_string_null('sum_facility_maintenance') }} AS NUMERIC) AS sum_facility_maintenance,
    SAFE_CAST({{ trim_make_empty_string_null('sum_general_administration') }} AS NUMERIC) AS sum_general_administration,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('sum_vehicle_maintenance') }} AS NUMERIC) AS sum_vehicle_maintenance,
    SAFE_CAST({{ trim_make_empty_string_null('sum_vehicle_operations') }} AS NUMERIC) AS sum_vehicle_operations,
