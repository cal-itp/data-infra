...
SELECT
    ...
    SAFE_CAST({{ trim_make_empty_string_null('facility_maintenance') }} AS NUMERIC) AS facility_maintenance,
    {{ trim_make_empty_string_null('facility_maintenance_1') }} AS facility_maintenance_1,
    SAFE_CAST({{ trim_make_empty_string_null('general_administration') }} AS NUMERIC) AS general_administration,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('vehicle_maintenance') }} AS NUMERIC) AS vehicle_maintenance,
    {{ trim_make_empty_string_null('vehicle_maintenance_1') }} AS vehicle_maintenance_1,
    SAFE_CAST({{ trim_make_empty_string_null('vehicle_operations') }} AS NUMERIC) AS vehicle_operations,
