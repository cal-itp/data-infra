...
SELECT
    ...
    SAFE_CAST({{ trim_make_empty_string_null('casualty_and_liability') }} AS NUMERIC) AS casualty_and_liability,
    {{ trim_make_empty_string_null('casualty_and_liability_1') }} AS casualty_and_liability_1,
    {{ trim_make_empty_string_null('city') }} AS city,
    SAFE_CAST({{ trim_make_empty_string_null('fringe_benefits') }} AS NUMERIC) AS fringe_benefits,
    {{ trim_make_empty_string_null('fringe_benefits_questionable') }} AS fringe_benefits_questionable,
    SAFE_CAST({{ trim_make_empty_string_null('fuel_and_lube') }} AS NUMERIC) AS fuel_and_lube,
    {{ trim_make_empty_string_null('fuel_and_lube_questionable') }} AS fuel_and_lube_questionable,
    SAFE_CAST({{ trim_make_empty_string_null('miscellaneous') }} AS NUMERIC) AS miscellaneous,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('operator_paid_absences') }} AS NUMERIC) AS operator_paid_absences,
    {{ trim_make_empty_string_null('operator_paid_absences_1') }} AS operator_paid_absences_1,
    SAFE_CAST({{ trim_make_empty_string_null('operators_wages') }} AS NUMERIC) AS operators_wages,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('other_materials_supplies') }} AS NUMERIC) AS other_materials_supplies,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('other_salaries_wages') }} AS NUMERIC) AS other_salaries_wages,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('reduced_reporter_expenses') }} AS NUMERIC) AS reduced_reporter_expenses,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('separate_report_amount') }} AS NUMERIC) AS separate_report_amount,
    {{ trim_make_empty_string_null('separate_report_amount_1') }} AS separate_report_amount_1,
    SAFE_CAST({{ trim_make_empty_string_null('services') }} AS NUMERIC) AS services,
    {{ trim_make_empty_string_null('services_questionable') }} AS services_questionable,
    {{ trim_make_empty_string_null('state') }} AS state,
    SAFE_CAST({{ trim_make_empty_string_null('taxes') }} AS NUMERIC) AS taxes,
    {{ trim_make_empty_string_null('taxes_questionable') }} AS taxes_questionable,
    SAFE_CAST({{ trim_make_empty_string_null('tires') }} AS NUMERIC) AS tires,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('utilities') }} AS NUMERIC) AS utilities,
