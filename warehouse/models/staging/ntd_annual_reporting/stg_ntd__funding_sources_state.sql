...
SELECT
    ...
    SAFE_CAST({{ trim_make_empty_string_null('general_funds') }} AS NUMERIC) AS general_funds,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('transportation_funds') }} AS NUMERIC) AS transportation_funds,
