...
stg_ntd__service_by_mode_and_time_period AS (
    SELECT
        ...
        SAFE_CAST(REPLACE(average_passenger_trip_length_aptl_, ',', '') AS NUMERIC) AS average_passenger_trip_length_aptl_,
        SAFE_CAST(REPLACE(average_speed, ',', '') AS NUMERIC) AS average_speed,
        ...
        {{ trim_make_empty_string_null('primary_uza_code') }} AS primary_uza_code,
