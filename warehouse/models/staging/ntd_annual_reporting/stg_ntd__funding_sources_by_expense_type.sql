...
SELECT
    ...
    SAFE_CAST({{ trim_make_empty_string_null('fares_and_other_directly') }} AS NUMERIC) AS fares_and_other_directly,
    {{ trim_make_empty_string_null('fares_and_other_directly_1') }} AS fares_and_other_directly_1,
    SAFE_CAST({{ trim_make_empty_string_null('federal') }} AS NUMERIC) AS federal,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('local') }} AS NUMERIC) AS local,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('state_1') }} AS NUMERIC) AS state_1,
    {{ trim_make_empty_string_null('state_questionable') }} AS state_questionable,
    SAFE_CAST({{ trim_make_empty_string_null('taxes_fees_levied_by_transit') }} AS NUMERIC) AS taxes_fees_levied_by_transit,
