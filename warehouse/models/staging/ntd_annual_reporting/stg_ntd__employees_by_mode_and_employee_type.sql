...
SELECT
    ...
    SAFE_CAST({{ trim_make_empty_string_null('capital_labor_count') }} AS NUMERIC) AS capital_labor_count,
    {{ trim_make_empty_string_null('capital_labor_count_q') }} AS capital_labor_count_q,
    SAFE_CAST({{ trim_make_empty_string_null('capital_labor_hours') }} AS NUMERIC) AS capital_labor_hours,
    {{ trim_make_empty_string_null('capital_labor_hours_q') }} AS capital_labor_hours_q,
    {{ trim_make_empty_string_null('city') }} AS city,
    SAFE_CAST({{ trim_make_empty_string_null('facility_maintenance_count') }} AS NUMERIC) AS facility_maintenance_count,
    {{ trim_make_empty_string_null('facility_maintenance_count_q') }} AS facility_maintenance_count_q,
    SAFE_CAST({{ trim_make_empty_string_null('facility_maintenance_hours') }} AS NUMERIC) AS facility_maintenance_hours,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('general_administration_count') }} AS NUMERIC) AS general_administration_count,
    {{ trim_make_empty_string_null('general_administration_count_q') }} AS general_administration_count_q,
    SAFE_CAST({{ trim_make_empty_string_null('general_administration_hours') }} AS NUMERIC) AS general_administration_hours,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('total_employee_count') }} AS NUMERIC) AS total_employee_count,
    {{ trim_make_empty_string_null('total_employee_count_q') }} AS total_employee_count_q,
    SAFE_CAST({{ trim_make_empty_string_null('total_hours') }} AS NUMERIC) AS total_hours,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('vehicle_maintenance_count') }} AS NUMERIC) AS vehicle_maintenance_count,
    {{ trim_make_empty_string_null('vehicle_maintenance_count_q') }} AS vehicle_maintenance_count_q,
    SAFE_CAST({{ trim_make_empty_string_null('vehicle_maintenance_hours') }} AS NUMERIC) AS vehicle_maintenance_hours,
    {{ trim_make_empty_string_null('vehicle_maintenance_hours_q') }} AS vehicle_maintenance_hours_q,
    SAFE_CAST({{ trim_make_empty_string_null('vehicle_operations_count') }} AS NUMERIC) AS vehicle_operations_count,
    {{ trim_make_empty_string_null('vehicle_operations_count_q') }} AS vehicle_operations_count_q,
    SAFE_CAST({{ trim_make_empty_string_null('vehicle_operations_hours') }} AS NUMERIC) AS vehicle_operations_hours,
