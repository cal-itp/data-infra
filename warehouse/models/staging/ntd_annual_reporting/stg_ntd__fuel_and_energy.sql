...
SELECT
    ...
    SAFE_CAST({{ trim_make_empty_string_null('bio_diesel_gal') }} AS NUMERIC) AS bio_diesel_gal,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('compressed_natural_gas') }} AS NUMERIC) AS compressed_natural_gas,
    SAFE_CAST({{ trim_make_empty_string_null('compressed_natural_gas_mpg') }} AS NUMERIC) AS compressed_natural_gas_mpg,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('compressed_natural_gas_gal') }} AS NUMERIC) AS compressed_natural_gas_gal,
    {{ trim_make_empty_string_null('compressed_natural_gas_gal_1') }} AS compressed_natural_gas_gal_1,
    SAFE_CAST({{ trim_make_empty_string_null('diesel') }} AS NUMERIC) AS diesel,
    {{ trim_make_empty_string_null('diesel_questionable') }} AS diesel_questionable,
    SAFE_CAST({{ trim_make_empty_string_null('diesel_gal') }} AS NUMERIC) AS diesel_gal,
    {{ trim_make_empty_string_null('diesel_gal_questionable') }} AS diesel_gal_questionable,
    SAFE_CAST({{ trim_make_empty_string_null('diesel_mpg') }} AS NUMERIC) AS diesel_mpg,
    {{ trim_make_empty_string_null('diesel_mpg_questionable') }} AS diesel_mpg_questionable,
    SAFE_CAST({{ trim_make_empty_string_null('electric_battery') }} AS NUMERIC) AS electric_battery,
    {{ trim_make_empty_string_null('electric_battery_questionable') }} AS electric_battery_questionable,
    SAFE_CAST({{ trim_make_empty_string_null('electric_battery_kwh') }} AS NUMERIC) AS electric_battery_kwh,
    {{ trim_make_empty_string_null('electric_battery_kwh_1') }} AS electric_battery_kwh_1,
    SAFE_CAST({{ trim_make_empty_string_null('electric_battery_mi_kwh') }} AS NUMERIC) AS electric_battery_mi_kwh,
    {{ trim_make_empty_string_null('electric_battery_mi_kwh_1') }} AS electric_battery_mi_kwh_1,
    SAFE_CAST({{ trim_make_empty_string_null('electric_propulsion') }} AS NUMERIC) AS electric_propulsion,
    {{ trim_make_empty_string_null('electric_propulsion_1') }} AS electric_propulsion_1,
    SAFE_CAST({{ trim_make_empty_string_null('electric_propulsion_kwh') }} AS NUMERIC) AS electric_propulsion_kwh,
    {{ trim_make_empty_string_null('electric_propulsion_kwh_1') }} AS electric_propulsion_kwh_1,
    SAFE_CAST({{ trim_make_empty_string_null('electric_propulsion_mi_kwh') }} AS NUMERIC) AS electric_propulsion_mi_kwh,
    {{ trim_make_empty_string_null('electric_propulsion_mi_kwh_1') }} AS electric_propulsion_mi_kwh_1,
    SAFE_CAST({{ trim_make_empty_string_null('gasoline') }} AS NUMERIC) AS gasoline,
    SAFE_CAST({{ trim_make_empty_string_null('gasoline_mpg') }} AS NUMERIC) AS gasoline_mpg,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('gasoline_gal') }} AS NUMERIC) AS gasoline_gal,
    {{ trim_make_empty_string_null('gasoline_gal_questionable') }} AS gasoline_gal_questionable,
    SAFE_CAST({{ trim_make_empty_string_null('hydrogen') }} AS NUMERIC) AS hydrogen,
    SAFE_CAST({{ trim_make_empty_string_null('hydrogen_mpkg_') }} AS NUMERIC) AS hydrogen_mpkg_,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('hydrogen_kg_') }} AS NUMERIC) AS hydrogen_kg_,
    {{ trim_make_empty_string_null('hydrogen_kg_questionable') }} AS hydrogen_kg_questionable,
    SAFE_CAST({{ trim_make_empty_string_null('liquefied_petroleum_gas') }} AS NUMERIC) AS liquefied_petroleum_gas,
    SAFE_CAST({{ trim_make_empty_string_null('liquefied_petroleum_gas_mpg') }} AS NUMERIC) AS liquefied_petroleum_gas_mpg,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('liquefied_petroleum_gas_gal') }} AS NUMERIC) AS liquefied_petroleum_gas_gal,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('other_fuel') }} AS NUMERIC) AS other_fuel,
    SAFE_CAST({{ trim_make_empty_string_null('other_fuel_mpg') }} AS NUMERIC) AS other_fuel_mpg,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('other_fuel_gal_gal_equivalent') }} AS NUMERIC) AS other_fuel_gal_gal_equivalent,
