...
stg_ntd__2022_agency_information AS (
    SELECT
        ...
        {{ convert_epoch_timestamp('original_due_date') }} AS original_due_date,
        ...
        {{ convert_epoch_timestamp('fy_end_date') }} AS fy_end_date,
...
SELECT * FROM stg_ntd__2022_agency_information
