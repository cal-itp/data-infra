...
SELECT
    SAFE_CAST({{ trim_make_empty_string_null('count_administrative_buildings_q') }} AS NUMERIC) AS count_administrative_buildings_q,
    SAFE_CAST({{ trim_make_empty_string_null('count_communication_information_q') }} AS NUMERIC) AS count_communication_information_q,
    SAFE_CAST({{ trim_make_empty_string_null('count_fare_collection_equipment_q') }} AS NUMERIC) AS count_fare_collection_equipment_q,
    SAFE_CAST({{ trim_make_empty_string_null('count_maintenance_buildings_q') }} AS NUMERIC) AS count_maintenance_buildings_q,
    SAFE_CAST({{ trim_make_empty_string_null('count_other_q') }} AS NUMERIC) AS count_other_q,
    SAFE_CAST({{ trim_make_empty_string_null('count_other_vehicles_q') }} AS NUMERIC) AS count_other_vehicles_q,
    SAFE_CAST({{ trim_make_empty_string_null('count_passenger_vehicles_q') }} AS NUMERIC) AS count_passenger_vehicles_q,
    SAFE_CAST({{ trim_make_empty_string_null('count_reduced_reporter_q') }} AS NUMERIC) AS count_reduced_reporter_q,
    SAFE_CAST({{ trim_make_empty_string_null('count_stations_q') }} AS NUMERIC) AS count_stations_q,
