...
SELECT
    SAFE_CAST({{ trim_make_empty_string_null('_1940s') }} AS NUMERIC) AS _1940s,
    SAFE_CAST({{ trim_make_empty_string_null('_1950s') }} AS NUMERIC) AS _1950s,
    SAFE_CAST({{ trim_make_empty_string_null('_1960s') }} AS NUMERIC) AS _1960s,
    SAFE_CAST({{ trim_make_empty_string_null('_1970s') }} AS NUMERIC) AS _1970s,
    SAFE_CAST({{ trim_make_empty_string_null('_1980s') }} AS NUMERIC) AS _1980s,
    SAFE_CAST({{ trim_make_empty_string_null('_1990s') }} AS NUMERIC) AS _1990s,
    SAFE_CAST({{ trim_make_empty_string_null('_2000s') }} AS NUMERIC) AS _2000s,
    SAFE_CAST({{ trim_make_empty_string_null('_2010s') }} AS NUMERIC) AS _2010s,
    SAFE_CAST({{ trim_make_empty_string_null('_2020s') }} AS NUMERIC) AS _2020s,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('pre1940') }} AS NUMERIC) AS pre1940,
