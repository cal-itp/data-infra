...
SELECT
    ...
    SAFE_CAST({{ trim_make_empty_string_null('major_mechanical_failures') }} AS NUMERIC) AS major_mechanical_failures,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('other_mechanical_failures') }} AS NUMERIC) AS other_mechanical_failures,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('total_mechanical_failures') }} AS NUMERIC) AS total_mechanical_failures,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('vehicle_passenger_car_miles') }} AS NUMERIC) AS vehicle_passenger_car_miles,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('vehicle_passenger_car_revenue') }} AS NUMERIC) AS vehicle_passenger_car_revenue,
    dt,
    execution_ts
