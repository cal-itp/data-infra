...
SELECT
    SAFE_CAST({{ trim_make_empty_string_null('_200_to_300_vehicles') }} AS NUMERIC) AS _200_to_300_vehicles,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('heavy_maintenance_facilities') }} AS NUMERIC) AS heavy_maintenance_facilities,
    {{ trim_make_empty_string_null('heavy_maintenance_facilities_1') }} AS heavy_maintenance_facilities_1,
    SAFE_CAST({{ trim_make_empty_string_null('leased_by_pt_provider') }} AS NUMERIC) AS leased_by_pt_provider,
    {{ trim_make_empty_string_null('leased_by_pt_provider_1') }} AS leased_by_pt_provider_1,
    SAFE_CAST({{ trim_make_empty_string_null('leased_by_public_agency') }} AS NUMERIC) AS leased_by_public_agency,
    {{ trim_make_empty_string_null('leased_by_public_agency_1') }} AS leased_by_public_agency_1,
    SAFE_CAST({{ trim_make_empty_string_null('leased_from_a_private_entity') }} AS NUMERIC) AS leased_from_a_private_entity,
    {{ trim_make_empty_string_null('leased_from_a_private_entity_1') }} AS leased_from_a_private_entity_1,
    SAFE_CAST({{ trim_make_empty_string_null('leased_from_a_public_entity') }} AS NUMERIC) AS leased_from_a_public_entity,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('over_300_vehicles') }} AS NUMERIC) AS over_300_vehicles,
    {{ trim_make_empty_string_null('over_300_vehicles_questionable') }} AS over_300_vehicles_questionable,
    SAFE_CAST({{ trim_make_empty_string_null('owned') }} AS NUMERIC) AS owned,
    {{ trim_make_empty_string_null('owned_questionable') }} AS owned_questionable,
    SAFE_CAST({{ trim_make_empty_string_null('owned_by_pt_provider') }} AS NUMERIC) AS owned_by_pt_provider,
    {{ trim_make_empty_string_null('owned_by_pt_provider_1') }} AS owned_by_pt_provider_1,
    SAFE_CAST({{ trim_make_empty_string_null('owned_by_public_agency') }} AS NUMERIC) AS owned_by_public_agency,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('under_200_vehicles') }} AS NUMERIC) AS under_200_vehicles,
