...
SELECT
    ...
    SAFE_CAST({{ trim_make_empty_string_null('at_grade_ballast_including') }} AS NUMERIC) AS at_grade_ballast_including,
    {{ trim_make_empty_string_null('at_grade_ballast_including_1') }} AS at_grade_ballast_including_1,
    SAFE_CAST({{ trim_make_empty_string_null('at_grade_in_street_embedded') }} AS NUMERIC) AS at_grade_in_street_embedded,
    {{ trim_make_empty_string_null('at_grade_in_street_embedded_1') }} AS at_grade_in_street_embedded_1,
    SAFE_CAST({{ trim_make_empty_string_null('below_grade_bored_or_blasted') }} AS NUMERIC) AS below_grade_bored_or_blasted,
    {{ trim_make_empty_string_null('below_grade_bored_or_blasted_1') }} AS below_grade_bored_or_blasted_1,
    SAFE_CAST({{ trim_make_empty_string_null('below_grade_cut_and_cover') }} AS NUMERIC) AS below_grade_cut_and_cover,
    {{ trim_make_empty_string_null('below_grade_cut_and_cover_1') }} AS below_grade_cut_and_cover_1,
    SAFE_CAST({{ trim_make_empty_string_null('below_grade_retained_cut') }} AS NUMERIC) AS below_grade_retained_cut,
    {{ trim_make_empty_string_null('below_grade_retained_cut_1') }} AS below_grade_retained_cut_1,
    SAFE_CAST({{ trim_make_empty_string_null('below_grade_submerged_tube') }} AS NUMERIC) AS below_grade_submerged_tube,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('controlled_access_high') }} AS NUMERIC) AS controlled_access_high,
    {{ trim_make_empty_string_null('controlled_access_high_1') }} AS controlled_access_high_1,
    SAFE_CAST({{ trim_make_empty_string_null('double_crossover') }} AS NUMERIC) AS double_crossover,
    {{ trim_make_empty_string_null('double_crossover_q') }} AS double_crossover_q,
    SAFE_CAST({{ trim_make_empty_string_null('elevated_concrete') }} AS NUMERIC) AS elevated_concrete,
    {{ trim_make_empty_string_null('elevated_concrete_q') }} AS elevated_concrete_q,
    SAFE_CAST({{ trim_make_empty_string_null('elevated_retained_fill') }} AS NUMERIC) AS elevated_retained_fill,
    {{ trim_make_empty_string_null('elevated_retained_fill_q') }} AS elevated_retained_fill_q,
    SAFE_CAST({{ trim_make_empty_string_null('elevated_steel_viaduct_or') }} AS NUMERIC) AS elevated_steel_viaduct_or,
    {{ trim_make_empty_string_null('elevated_steel_viaduct_or_1') }} AS elevated_steel_viaduct_or_1,
    SAFE_CAST({{ trim_make_empty_string_null('exclusive_fixed_guideway') }} AS NUMERIC) AS exclusive_fixed_guideway,
    {{ trim_make_empty_string_null('exclusive_fixed_guideway_1') }} AS exclusive_fixed_guideway_1,
    SAFE_CAST({{ trim_make_empty_string_null('exclusive_high_intensity') }} AS NUMERIC) AS exclusive_high_intensity,
    {{ trim_make_empty_string_null('exclusive_high_intensity_1') }} AS exclusive_high_intensity_1,
    SAFE_CAST({{ trim_make_empty_string_null('grade_crossings') }} AS NUMERIC) AS grade_crossings,
    {{ trim_make_empty_string_null('grade_crossings_q') }} AS grade_crossings_q,
    SAFE_CAST({{ trim_make_empty_string_null('lapped_turnout') }} AS NUMERIC) AS lapped_turnout,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('rail_crossings') }} AS NUMERIC) AS rail_crossings,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('single_crossover') }} AS NUMERIC) AS single_crossover,
    {{ trim_make_empty_string_null('single_crossover_q') }} AS single_crossover_q,
    SAFE_CAST({{ trim_make_empty_string_null('single_turnout') }} AS NUMERIC) AS single_turnout,
    {{ trim_make_empty_string_null('single_turnout_q') }} AS single_turnout_q,
    SAFE_CAST({{ trim_make_empty_string_null('slip_switch') }} AS NUMERIC) AS slip_switch,
    {{ trim_make_empty_string_null('slip_switch_q') }} AS slip_switch_q,
    {{ trim_make_empty_string_null('state') }} AS state,
    {{ trim_make_empty_string_null('total_miles') }} AS total_miles,
    SAFE_CAST({{ trim_make_empty_string_null('total_track_miles') }} AS NUMERIC) AS total_track_miles,
