...
SELECT
    ...
    SAFE_CAST({{ trim_make_empty_string_null('derailed_cars_count') }} AS FLOAT) AS derailed_cars_count,
    {{ trim_make_empty_string_null('fuel_type') }} AS fuel_type,
    {{ trim_make_empty_string_null('transit_y_n') }} AS transit_y_n,
    SAFE_CAST({{ trim_make_empty_string_null('evacuation') }} AS BOOLEAN) AS evacuation,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('total_serious_injuries') }} AS INTEGER) AS total_serious_injuries,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('trespasser_inuries_subtotal_') }} AS INTEGER) AS trespasser_inuries_subtotal_,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('pederstiran_in_crosswalk') }} AS INTEGER) AS pederstiran_in_crosswalk,
    SAFE_CAST({{ trim_make_empty_string_null('__computed_region_8fe2_rd7y') }} AS FLOAT) AS __computed_region_8fe2_rd7y,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('trespasser_serious_injuries_subtotal_') }} AS INTEGER) AS trespasser_serious_injuries_subtotal_,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('trespasser_fatalities_subtotal_') }} AS INTEGER) AS trespasser_fatalities_subtotal_,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('evac_to_right_of_way') }} AS BOOLEAN) AS evac_to_right_of_way,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('life_safety_y_n') }} AS BOOLEAN) AS life_safety_y_n,
    latlon,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('number_of_cars_on_involved_transit_vehicles') }} AS INTEGER) AS number_of_cars_on_involved_transit_vehicles,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('__computed_region_m2nu_4dib') }} AS FLOAT) AS __computed_region_m2nu_4dib,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('assault_homicide_transit_worker_flag') }} AS BOOLEAN) AS assault_homicide_transit_worker_flag,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('pederstiran_in_crosswalk_1') }} AS INTEGER) AS pederstiran_in_crosswalk_1,
    ...
    SAFE_CAST({{ trim_make_empty_string_null('uace_code') }} AS INTEGER) AS uace_code,
    dt,
    execution_ts
