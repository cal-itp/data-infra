...
stg_ntd__major_safety_events AS (
    SELECT
        {{ dbt_utils.generate_surrogate_key(['_5_digit_ntd_id', 'year', 'incident_number']) }} AS key,
        ...
        {{ trim_make_empty_string_null('towed_y_n') }} AS towed_y_n,
        ...
        {{ trim_make_empty_string_null('life_safety_y_n') }} AS life_safety_y_n,
        {{ trim_make_empty_string_null('evac_to_right_of_way') }} AS evac_to_right_of_way,
        {{ trim_make_empty_string_null('self_evacuation_y_n') }} AS self_evacuation_y_n,
        {{ trim_make_empty_string_null('intentional_y_n') }} AS intentional_y_n,
        ...
        {{ trim_make_empty_string_null('__computed_region_m2nu_4dib') }} AS computed_region_m2nu_4dib,
        {{ trim_make_empty_string_null('__computed_region_8fe2_rd7y') }} AS computed_region_8fe2_rd7y,
        ...
        {{ trim_make_empty_string_null('other_vehicle_type_list') }} AS other_vehicle_type_list,
        ...
        {{ trim_make_empty_string_null('non_transit_vehicle_action_list') }} AS non_transit_vehicle_action_list,
        ...
        {{ trim_make_empty_string_null('transit_vehicle_type') }} AS transit_vehicle_type,
        ...
        {{ trim_make_empty_string_null('multiple_locations_list') }} AS multiple_locations_list,
        ...
        {{ trim_make_empty_string_null('rail_grade_crossing_comment') }} AS rail_grade_crossing_comment,
        ...
        {{ trim_make_empty_string_null('weather_comment') }} AS weather_comment,
