...
stg_ntd_annual_data__stations_and_facilities_by_agency_and_facility_type AS (
    SELECT *
    FROM get_latest_extract
)

SELECT * FROM stg_ntd_annual_data__stations_and_facilities_by_agency_and_facility_type
