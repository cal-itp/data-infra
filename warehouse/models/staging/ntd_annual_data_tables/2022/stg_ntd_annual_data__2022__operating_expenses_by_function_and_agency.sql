...
stg_ntd_annual_data__2022__operating_expenses_by_function_and_agency AS (
    SELECT *
    FROM get_latest_extract
)

SELECT * FROM stg_ntd_annual_data__2022__operating_expenses_by_function_and_agency
