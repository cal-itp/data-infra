WITH source AS (
    SELECT *
    FROM {{ source('external_ntd__funding_and_expenses', 'historical__service_data_and_operating_expenses_time_series_by_mode__fares') }}
),
...
stg_ntd__service_data_and_operating_expenses_time_series_by_mode__fares AS (
    SELECT
        ...
        {{ trim_make_empty_string_null('_2000') }} AS _2000,
        ...
        {{ trim_make_empty_string_null('_1998') }} AS _1998,
        SAFE_CAST(_2003 AS FLOAT64) AS _2003,
        SAFE_CAST(_2022 AS FLOAT64) AS _2022,
        {{ trim_make_empty_string_null('_1999') }} AS _1999,
        SAFE_CAST(last_report_year AS INT64) AS last_report_year,
        {{ trim_make_empty_string_null('_1997') }} AS _1997,
        {{ trim_make_empty_string_null('_2001') }} AS _2001,
        {{ trim_make_empty_string_null('_1996') }} AS _1996,
        SAFE_CAST(_2011 AS FLOAT64) AS _2011,
        SAFE_CAST(_2023 AS FLOAT64) AS _2023,
        SAFE_CAST(_2015 AS FLOAT64) AS _2015,
        {{ trim_make_empty_string_null('_1995') }} AS _1995,
        ...
        {{ trim_make_empty_string_null('_1994') }} AS _1994,
        ...
        {{ trim_make_empty_string_null('_1992') }} AS _1992,
        ...
        {{ trim_make_empty_string_null('_1991') }} AS _1991,
        SAFE_CAST(_2018 AS FLOAT64) AS _2018,
        SAFE_CAST(census_year AS INT64) AS census_year,
        {{ trim_make_empty_string_null('_1993') }} AS _1993,
...
SELECT * FROM stg_ntd__service_data_and_operating_expenses_time_series_by_mode__fares
