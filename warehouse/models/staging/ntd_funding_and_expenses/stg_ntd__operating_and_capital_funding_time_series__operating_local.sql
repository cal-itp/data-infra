WITH source AS (
    SELECT *
    FROM {{ source('external_ntd__funding_and_expenses', 'historical__operating_and_capital_funding_time_series__operating_local') }}
),
...
stg_ntd__operating_and_capital_funding_time_series__operating_local AS (
    SELECT
...
SELECT * FROM stg_ntd__operating_and_capital_funding_time_series__operating_local
