WITH source AS (
    SELECT *
    FROM {{ source('external_ntd__funding_and_expenses', 'historical__operating_and_capital_funding_time_series__operating_federal') }}
),
...
stg_ntd__operating_and_capital_funding_time_series__operating_federal AS (
    SELECT
        ...
        {{ trim_make_empty_string_null('_2024_status') }} AS _2024_status,
...
SELECT * FROM stg_ntd__operating_and_capital_funding_time_series__operating_federal
