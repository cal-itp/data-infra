...
stg_kuba__device_properties AS (
    SELECT
        device.fo_device_logical_id AS device_fo_device_logical_id,
        device.fo_device_type AS device_fo_device_type,
        device.fo_device_type_model AS device_fo_device_type_model,
        device.fo_device_serial_number AS device_fo_device_serial_number,
        device.fo_device_description AS device_fo_device_description,
        device.fo_device_location_id AS device_fo_device_location_id,
        device.fo_device_location AS device_fo_device_location,
        device.fo_device_last_connection AS device_fo_device_last_connection,
        device_replicator_info.software_version AS device_replicator_info_software_version,
        device_replicator_info.software_last_connection AS device_replicator_info_software_last_connection,
        device_replicator_info.cd_version AS device_replicator_info_cd_version,
        device_replicator_info.cd_last_connection AS device_replicator_info_cd_last_connection,
        device_replicator_info.dataset_version AS device_replicator_info_dataset_version,
        device_replicator_info.dataset_last_connection AS device_replicator_info_dataset_last_connection,
        device_replicator_info.denylist_version AS device_replicator_info_denylist_version,
        device_replicator_info.denylist_last_connection AS device_replicator_info_denylist_last_connection,
        device_replicator_info.acceptlist_version AS device_replicator_info_acceptlist_version,
        device_replicator_info.acceptlist_last_connection AS device_replicator_info_acceptlist_last_connection,
        device_replicator_info.binlist_version AS device_replicator_info_binlist_version,
        device_replicator_info.binlist_last_connection AS device_replicator_info_binlist_last_connection,
        device_replicator_info.asset_last_connection AS device_replicator_info_asset_last_connection,
        device_replicator_info.monitoring_last_connection AS device_replicator_info_monitoring_last_connection,
        device_replicator_info.ud_last_transaction_time AS device_replicator_info_ud_last_transaction_time,
        device_monitor_info.application__isdisabled AS device_monitor_info_application_isdisabled,
        device_monitor_info.application__isinservice AS device_monitor_info_application_isinservice,
        ...
        device_monitor_info.smartmedium__emv3000__batterylevel AS device_monitor_info_smartmedium_emv3000_battery_level,
