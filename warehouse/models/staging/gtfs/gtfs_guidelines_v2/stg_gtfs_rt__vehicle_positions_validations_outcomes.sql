WITH raw_validations_outcomes AS (
    ...
    FROM {{ source('external_gtfs_rt', 'vehicle_positions_validations_outcomes') }}
),

stg_gtfs_rt__vehicle_positions_validations_outcomes AS (
    SELECT
...
SELECT * FROM stg_gtfs_rt__vehicle_positions_validations_outcomes
