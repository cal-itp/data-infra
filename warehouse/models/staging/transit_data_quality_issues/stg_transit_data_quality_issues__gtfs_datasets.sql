...
once_daily_gtfs_datasets AS (
    {{ get_latest_dense_rank(
        external_table = source('airtable', 'transit_data_quality_issues__gtfs_datasets'),
        order_by = 'ts DESC', partition_by = 'dt'
        ) }}
),

stg_transit_data_quality_issues__gtfs_datasets AS (
    SELECT
        id,
        dataset_publisher,
        pipeline_url,
...
SELECT * FROM stg_transit_data_quality_issues__gtfs_datasets
