...
once_daily_services AS (
    {{ get_latest_dense_rank(
        external_table = source('airtable', 'transit_data_quality_issues__services'),
        order_by = 'ts DESC', partition_by = 'dt'
        ) }}
),

stg_transit_data_quality_issues__services AS (
    SELECT
        id,
...
SELECT * FROM stg_transit_data_quality_issues__services
